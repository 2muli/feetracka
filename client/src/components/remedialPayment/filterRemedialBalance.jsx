...
const FilterRemedialBalance = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await axios.get(
        `/remedialPayments/getRemedialStudentBalances?class=${studentClass}&term=${term}&minBalance=${minBalance}`
      );
  ...
  const doc = new jsPDF();
  doc.text(`Form ${studentClass} Students Term ${term} Remedial Balance`, 14, 15);
  ...
  return (
    <main className="sb-nav-fixed">
      ...
      <div className="container-fluid px-4">
        <h1 className="mt-4">Form {studentClass} Students Term {term}  Remedial Balance</h1>
        ...
        {students.length > 0 && <div className="d-flex justify-content-between mb-3 no-print">
          <div>
...
export default FilterRemedialBalance;